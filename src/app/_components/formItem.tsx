interface FormItem{
  ...
  function FormItem({label,placeholder,inputType, onChange, value}:FormItem){
    return <div className="flex flex-col md:w-[456px] h-[78px] mb-[32px] capitalize">
                  ...
                  <input required onChange={onChange} className="placeholder:text-[#848484] w-[auto] h-[48px] border rounded-[6px] pl-2 valid:bg-green-100" name={label} type={inputType} placeholder={placeholder} value={value} />
            </div>
  }
